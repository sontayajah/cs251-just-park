  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center" >
      ...
      <div id="logo">
        ...
        <h1><a href="index2.php">JustPark</a></h1>
      </div>
      ...
      <nav id="navbar" class="navbar">
        ...
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="search_guest.php">Search</a></li>
  ...
  <!-- ======= your code ======= -->
    ...
    <div class="model-container">
      <div class="model">
        ...
        <button type="button" onclick="location.href = 'login.php'" style= "right: 50px;" >
          Login
        </button>
        <button class = "cancel" >
          Cancel
